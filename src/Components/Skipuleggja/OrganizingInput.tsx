        ...
        <form>
            <div className="flex flex-col w-[350px]">
                ...
                <textarea
                    ...
                    className="h-44 md:h-[173px] bg-lightbackground border-[1.5px] border-darkbrown font-normal rounded-lg p-2 text-[#3E4140] font-quicksand resize-none focus:border-2 focus:border-[#6D726B] focus:outline-none focus:ring-0"
                />
                <div className="flex justify-between pt-6 gap-6">
                    <input
                        ...
                        type="text"
                        placeholder="Verð"
                        className="h-12 md:h-9 w-[70%] bg-lightbackground border-[1.5px] border-darkbrown font-normal rounded-lg pl-2 text-[#3E4140] font-quicksand focus:border-2 focus:border-[#6D726B] focus:outline-none focus:ring-0"
                    />
                    <BrownFilledButton 
                        label = "Staðfesta"
